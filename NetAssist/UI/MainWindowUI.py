...
Network_ico="./UI/Icons/Network.png"
broken_link_ico="./UI/Icons/broken_link_72px.ico"
link_ico="./UI/Icons/link_72px.ico"
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(broken_link_ico),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        icon1.addPixmap(
            QtGui.QPixmap(link_ico),
            QtGui.QIcon.Normal,
            QtGui.QIcon.On,
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.SendPlainTextEdit.setPlainText(_translate("Form", "输入要发送的数据"))
